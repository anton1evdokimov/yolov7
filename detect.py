...
if __name__ == '__main__':
    ...
    if is_grz:
        # parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp39/weights/best.pt', help='model.pt path(s)')
        ...
        parser.add_argument('--project', default='runs_conditioners/detect', help='save results to project/name')
